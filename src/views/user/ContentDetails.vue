  ...
  <div class="flex flex-col p-5 bg-gray-100 sm:h-auto text-black">
    <div class="video__player">
      <iframe
       ...
       :src="`https://www.youtube.com/embed/${content.content.content}?controls=1`"
        allowfullscreen
      ></iframe> 
      ...
      <div class="dekripsi__materi font-normal text-base flex flex-col">
        <div class="dekripsi ">
          <div class="collapse">
            ...
            <div
              class="collapse-title bg-primary "
            >
            ...
            <div
              class="collapse-content bg-white text-primary-content peer-checked:bg-white peer-checked:text-black"
            >
